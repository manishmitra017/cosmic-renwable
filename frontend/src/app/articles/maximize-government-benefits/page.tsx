          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              <div className="flex items-center justify-center gap-3 mb-6">
                ...
                <span className="glass px-3 py-1 rounded-full text-sm text-[#0072CE] border border-[#0072CE]/20">Guides</span>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 pb-16">
          ...
          >
            ...
            <div className="prose prose-lg max-w-none prose-invert">
              ...
              <div className="card-cosmic p-6 mb-8 border border-[#0072CE]/30">
                <h4 className="font-bold text-[#0072CE] mb-3">2025 Solar Rebate Value</h4>
              ...
              <div className="card-cosmic p-6 mb-8 border border-[#FFE500]/30">
                <h4 className="font-bold text-[#FFE500] mb-3">Battery Rebate Value</h4>
                <ul className="space-y-2 text-[#b0b0b0]">
                  <li className="flex items-start gap-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                ...
                <div className="card-cosmic p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 bg-[#0072CE] rounded-full flex items-center justify-center text-white font-bold">
                      NSW
                    </div>
                  ...
                  <ul className="space-y-3 text-[#b0b0b0]">
                    ...
                    <li className="flex items-start gap-2">
                      <ExclamationTriangleIcon className="w-5 h-5 text-[#FFE500] flex-shrink-0 mt-0.5" />
                ...
                <div className="card-cosmic p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 bg-[#0072CE]/80 rounded-full flex items-center justify-center text-white font-bold">
                      VIC
                    </div>
                ...
                <div className="card-cosmic p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 bg-[#FFE500] rounded-full flex items-center justify-center text-white font-bold">
                      ACT
                    </div>
                ...
                <div className="card-cosmic p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 bg-black rounded-full flex items-center justify-center text-[#FFE500] font-bold border border-[#FFE500]">
                      WA
                    </div>
              ...
              <div className="card-cosmic p-8 mb-10 bg-gradient-to-r from-[#FFE500]/10 to-[#0072CE]/10 border border-[#FFE500]/30">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center pt-3 text-xl">
                    ...
                    <span className="font-bold text-[#FFE500]">~$7,800+</span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                <div className="card-cosmic p-6">
                  <div className="w-12 h-12 bg-[#FFE500]/20 rounded-full flex items-center justify-center mb-4">
                    <span className="text-2xl text-[#FFE500] font-bold">1</span>
                  </div>
                ...
                <div className="card-cosmic p-6">
                  <div className="w-12 h-12 bg-[#FFE500]/20 rounded-full flex items-center justify-center mb-4">
                    <span className="text-2xl text-[#FFE500] font-bold">2</span>
                  </div>
                ...
                <div className="card-cosmic p-6">
                  <div className="w-12 h-12 bg-[#FFE500]/20 rounded-full flex items-center justify-center mb-4">
                    <span className="text-2xl text-[#FFE500] font-bold">3</span>
                  </div>
                ...
                <div className="card-cosmic p-6">
                  <div className="w-12 h-12 bg-[#FFE500]/20 rounded-full flex items-center justify-center mb-4">
                    <span className="text-2xl text-[#FFE500] font-bold">4</span>
                  </div>
              ...
              <div className="card-cosmic p-6 mb-10 border border-[#FFE500]/30">
                <h4 className="font-bold text-[#FFE500] mb-4 flex items-center gap-2">
