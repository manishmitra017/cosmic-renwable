...
export default function SolarBattery() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      color: 'text-[#FFE500]',
      bgColor: 'bg-[#FFE500]/10',
      borderColor: 'border-[#FFE500]/20'
    },
    {
      icon: BoltIcon,
      title: 'Backup Power',
  ...
  return (
    <div className="cosmic-bg">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-[#FFE500]/30 mb-6">
              ...
              <span className="text-[#FFE500] text-sm font-semibold">$8,000 REBATES AVAILABLE</span>
            </div>
      ...
      <section className="py-20 bg-gradient-to-b from-[#0072CE] to-[#005BB5] relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/4 w-64 h-64 bg-[#0072CE]/5 rounded-full blur-[80px]"></div>
      ...
      <section className="py-20 bg-[#0072CE] relative overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#FFE500]/5 rounded-full blur-[120px]"></div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {brands.map((brand, index) => (
              <div
                key={index}
                className="glass rounded-2xl p-8 border border-white/10 hover:border-[#FFE500]/30 transition-all duration-300 group"
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 bg-[#FFE500]/10 rounded-lg flex items-center justify-center">
                    <ShieldIcon className="w-5 h-5 text-[#FFE500]" />
                  </div>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/quote"
              className="btn-solar inline-flex items-center justify-center gap-2 px-10 py-4 rounded-xl text-lg font-bold shadow-2xl shadow-[#FFE500]/20 hover:shadow-[#FFE500]/40 transition-all"
            >
              Get Free Solar Battery Quote
              <ArrowRightIcon className="w-5 h-5" />
            </Link>
