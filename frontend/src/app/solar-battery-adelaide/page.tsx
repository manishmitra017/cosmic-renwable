    ...
    <div className="cosmic-bg">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              ...
              <br />
              <span className="text-gradient-solar">Adelaide, SA</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
              Why Adelaide Homes Need <span className="text-gradient-energy">Battery Storage</span>
            </h2>
      ...
      <section className="relative py-20 bg-[#0072CE]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
              Adelaide Battery <span className="text-gradient-solar">Packages</span>
            </h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="text-center mb-6">
                <span className="text-4xl font-bold text-white">$5,100</span>
                <span className="text-gray-400 ml-2">after rebate</span>
              </div>
            ...
            >
              ...
              <div className="text-center mb-6">
                <span className="text-4xl font-bold text-white">$8,900</span>
                <span className="text-gray-400 ml-2">after rebate</span>
              </div>
              <ul className="space-y-3 mb-8">
            ...
            >
              ...
              <div className="text-center mb-6">
                <span className="text-4xl font-bold text-white">$14,100</span>
                <span className="text-gray-400 ml-2">after rebate</span>
              </div>
              <ul className="space-y-3 mb-8">
