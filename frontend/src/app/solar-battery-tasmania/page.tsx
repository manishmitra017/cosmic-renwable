...
export default function SolarBatteryTasmania() {
  return (
    <div>
      ...
      <section className="relative min-h-[60vh] flex items-center overflow-hidden bg-gradient-to-br from-blue-600 to-indigo-700">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Solar Battery Installation Tasmania"
            fill
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight">
              Solar Battery Installation Tasmania
            </h1>
            <p className="text-xl sm:text-2xl text-blue-100 mb-8">
              Tasmania's #1 Choice for Solar Battery Systems | Government Rebates Available
            </p>
      ...
      {/* Tasmania-Specific Benefits */}
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">
            Why Tasmania Homes Need Solar Batteries
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Clean Energy State</h3>
              <p className="text-gray-600">
                Tasmania has excellent solar potential year-round. Batteries maximize renewable energy self-sufficiency in Australia's clean energy state.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">TAS Energy Costs</h3>
              <p className="text-gray-600">
                Tasmanian electricity prices are 24-29c/kWh. Solar batteries reduce dependence on grid power and lower energy bills.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Remote Area Security</h3>
              <p className="text-gray-600">
                Tasmania's rural areas benefit from battery backup during weather events. Energy independence for remote properties.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8 text-center">
              Tasmania Solar Battery Pricing
            </h2>
            <p className="text-xl text-gray-600 mb-12 text-center">
              Competitive pricing for Tasmanian residents
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-2xl transition-shadow">
                <div className="text-center">
                  ...
                  <div className="text-4xl font-bold text-green-600 mb-2">From $5,500</div>
              ...
              <div className="bg-gradient-to-br from-blue-600 to-indigo-700 text-white rounded-xl p-8 shadow-2xl transform scale-105">
                <div className="text-center">
                  ...
                  <div className="text-4xl font-bold mb-2">From $9,400</div>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-2xl transition-shadow">
                <div className="text-center">
                  ...
                  <div className="text-4xl font-bold text-green-600 mb-2">From $14,700</div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8 text-center">
            Tasmania Areas We Service
          </h2>
          <p className="text-xl text-gray-600 mb-12 text-center">
            Professional solar battery installation across Tasmania
          </p>
          ...
          <p className="text-center text-gray-600 mt-8">
            Don't see your area? We service all Tasmania regions. <Link href="/contact" className="text-green-600 font-semibold hover:underline">Contact us</Link> to confirm.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-emerald-600 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Save on Tasmania Electricity Bills?
          </h2>
          <p className="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
            Join 600+ Tasmanian households already saving with solar batteries
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/quote"
