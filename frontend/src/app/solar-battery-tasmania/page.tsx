        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          >
            <div className="inline-flex items-center gap-2 glass px-4 py-2 rounded-full mb-6 border border-[#FFE500]/20">
              <LeafIcon className="w-5 h-5 text-[#FFE500]" />
              <span className="text-[#FFE500] font-semibold">Australia&apos;s Clean Energy State</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-center text-gray-500 mt-6 text-sm">
              Don&apos;t see your area? We service all Tasmania regions. <Link href="/contact" className="text-[#0072CE] hover:underline">Contact us</Link> to confirm.
            </p>
          </motion.div>
        </div>
      </section>
