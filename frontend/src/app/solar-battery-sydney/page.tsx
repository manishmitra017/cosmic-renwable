        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-[#f5a623]/30 mb-6">
              ...
              <span className="text-[#f5a623] text-sm font-semibold">NSW&apos;S #1 CHOICE</span>
            </div>
            ...
            <p className="text-xl sm:text-2xl text-gray-300 mb-8">
              Government Rebates Up to <span className="text-[#f5a623] font-bold">$2,400</span>
            </p>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-400">
                NSW residents can access up to <span className="text-[#f5a623] font-semibold">$2,400</span> in government rebates
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="glass rounded-2xl p-8 border border-white/10 hover:border-[#00d4ff]/30 transition-all duration-300">
                <div className="text-center">
                  ...
                  <div className="text-4xl font-bold text-[#00d4ff] mb-2">From $5,200</div>
              ...
              <div className="relative glass rounded-2xl p-8 border-2 border-[#f5a623]/50 transform md:scale-105 shadow-2xl shadow-[#f5a623]/10">
                ...
                <div className="text-center">
                  ...
                  <div className="text-4xl font-bold text-[#f5a623] mb-2">From $8,700</div>
              ...
              <div className="glass rounded-2xl p-8 border border-white/10 hover:border-[#00d4ff]/30 transition-all duration-300">
                <div className="text-center">
                  ...
                  <div className="text-4xl font-bold text-[#00d4ff] mb-2">From $14,200</div>
