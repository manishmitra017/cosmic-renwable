    ...
    <div>
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl text-blue-100 mb-8">
              NSW's #1 Choice for Solar Battery Systems | Government Rebates Up to $2,400
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">
            Why Sydney Homes Need Solar Batteries
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Abundant Sunshine</h3>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">NSW Energy Costs</h3>
              <p className="text-gray-600">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Blackout Protection</h3>
              <p className="text-gray-600">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8 text-center">
              Sydney Solar Battery Pricing (After Rebates)
            </h2>
            <p className="text-xl text-gray-600 mb-12 text-center">
              NSW residents can access up to $2,400 in government rebates
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-2xl transition-shadow">
                <div className="text-center">
                  ...
                  <div className="text-4xl font-bold text-green-600 mb-2">From $5,200</div>
              ...
              <div className="bg-gradient-to-br from-blue-600 to-indigo-700 text-white rounded-xl p-8 shadow-2xl transform scale-105">
                <div className="text-center">
                  ...
                  <div className="text-4xl font-bold mb-2">From $8,700</div>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-2xl transition-shadow">
                <div className="text-center">
                  ...
                  <div className="text-4xl font-bold text-green-600 mb-2">From $14,200</div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-gray-600 mt-8">
            Don't see your suburb? We service all Greater Sydney areas. <Link href="/contact" className="text-green-600 font-semibold hover:underline">Contact us</Link> to confirm.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-emerald-600 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Save on Sydney Electricity Bills?
          </h2>
