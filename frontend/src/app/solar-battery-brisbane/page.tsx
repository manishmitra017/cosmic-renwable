        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/30 mb-6">
              ...
              <span className="text-[#fee000] text-sm font-semibold">QUEENSLAND&apos;S #1 CHOICE</span>
            </div>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight font-display">
              ...
              <span className="block text-[#fee000]">Brisbane</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/quote"
                className="bg-[#fee000] text-[#083941] hover:bg-[#e5ca00] inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-lg font-semibold shadow-xl"
              >
              ...
              <a
                href="tel:1300090984"
                className="bg-white text-[#0073b9] hover:bg-gray-100 inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-lg font-semibold"
              >
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-[#666666]">
                Queensland residents can access up to <span className="text-[#0073b9] font-semibold">$3,500</span> in federal rebates
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200 hover:border-[#0073b9] transition-all duration-300">
                <div className="text-center">
                  <h3 className="text-2xl font-bold text-[#333333] mb-4">Essential</h3>
                  <div className="text-4xl font-bold text-[#0073b9] mb-2">From $4,990</div>
                  ...
                  <Link href="/quote" className="bg-[#0073b9] text-white hover:bg-[#005a91] w-full inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold">
                    Get Brisbane Quote
                  </Link>
                </div>
              </div>

              <div className="relative bg-white rounded-2xl p-8 border-2 border-[#0073b9] transform md:scale-105 shadow-2xl">
                ...
                <div className="text-center">
                  ...
                  <div className="text-4xl font-bold text-[#0073b9] mb-2">From $8,490</div>
                  ...
                  <Link href="/quote" className="bg-[#fee000] text-[#083941] hover:bg-[#e5ca00] w-full inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold">
                    Get Brisbane Quote
                  </Link>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200 hover:border-[#0073b9] transition-all duration-300">
                <div className="text-center">
                  ...
                  <div className="text-4xl font-bold text-[#0073b9] mb-2">From $13,990</div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
            {suburbs.map((suburb, index) => (
              <motion.div
                key={suburb}
                className="bg-white shadow-lg border border-gray-200 rounded-lg p-3 text-center hover:border-[#0073b9] transition-colors"
      ...
      <section className="py-20 relative overflow-hidden bg-[#fee000]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/quote"
              className="bg-[#0073b9] text-white hover:bg-[#005a91] inline-flex items-center justify-center gap-2 px-10 py-4 rounded-xl text-lg font-bold shadow-2xl"
            >
              Get Free Brisbane Quote
              <ArrowRightIcon className="w-5 h-5" />
            </Link>
            <a
              href="tel:1300090984"
              className="bg-[#083941] text-white hover:bg-[#0a4a54] inline-flex items-center justify-center gap-2 px-10 py-4 rounded-xl text-lg font-bold"
            >
              <PhoneIcon className="w-5 h-5" />
              1300 09 09 84
            </a>
