  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-emerald-600 to-green-600 text-white py-1.5 sm:py-2 fixed w-full top-0 z-50"
      >
          ...
          <div className="flex items-center justify-between h-14 sm:h-16 lg:h-20">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <button
                ...
                className="lg:hidden p-1.5 sm:p-2 text-gray-700 hover:text-emerald-600 hover:bg-gray-100 rounded-lg transition-colors"
      ...
      <div className={`${scrolled ? 'h-14 sm:h-16 lg:h-20' : 'h-[88px] sm:h-24 lg:h-28'} transition-all duration-300`} />
    </>
  )
}
