  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-emerald-600 to-green-600 text-white py-2 fixed w-full top-0 z-50"
      >
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center text-sm">
          <div className="flex items-center gap-6">
            <a href="tel:1300090984" className="flex items-center gap-2 hover:text-emerald-200 transition-colors">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              <span className="font-semibold">1300 09 09 84</span>
            </a>
            <span className="hidden sm:inline text-emerald-200">|</span>
            <span className="hidden sm:flex items-center gap-2 text-emerald-100">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center gap-4">
            <span className="hidden md:inline font-medium">Australia&apos;s Trusted Solar Experts</span>
            <div className="flex items-center gap-2">
              {[
                ...
                <a key={i} href={social.href} target="_blank" rel="noopener noreferrer" className="hover:text-emerald-200 transition-colors">
      ...
      <motion.header
        initial={{ y: 0 }}
        animate={{ y: scrolled ? 0 : 40 }}
        transition={{ duration: 0.3 }}
        className={`fixed w-full z-40 transition-all duration-300 ${
          scrolled
            ? 'top-0 bg-white shadow-xl'
          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <Link href="/" className="flex items-center gap-3 flex-shrink-0">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-xs text-emerald-600 font-medium">The Solar Energy Pioneers</p>
              </div>
            </Link>
            ...
            <div className="hidden lg:flex items-center gap-8">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-gray-700 hover:text-emerald-600 font-medium text-sm transition-colors relative group"
                >
                  {link.label}
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                href="tel:1300090984"
                className="hidden xl:flex items-center gap-2 px-4 py-2 text-emerald-700 hover:text-emerald-800 font-semibold transition-colors"
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm font-bold text-gray-900">1300 09 09 84</p>
                </div>
              </a>
              ...
              <Link
                href="/quote"
                className="bg-gradient-to-r from-emerald-500 to-green-500 hover:from-emerald-600 hover:to-green-600 text-white px-5 py-2.5 lg:px-6 lg:py-3 rounded-lg font-semibold text-sm shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/40 transition-all duration-300 flex items-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              <div className="max-w-7xl mx-auto px-4 py-4 space-y-1">
                ...
                <div className="pt-4 space-y-3 border-t border-gray-100 mt-4">
                  <a
                    href="tel:1300090984"
                    className="flex items-center justify-center gap-3 bg-gradient-to-r from-orange-500 to-red-500 text-white px-4 py-3 rounded-xl font-semibold shadow-lg"
                    onClick={() => setIsOpen(false)}
                  >
                  ...
                  <Link
                    href="/quote"
                    className="flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-500 to-green-500 text-white px-4 py-3 rounded-xl font-semibold shadow-lg"
                    onClick={() => setIsOpen(false)}
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
      ...
      <div className={`${scrolled ? 'h-16 lg:h-20' : 'h-24 lg:h-28'} transition-all duration-300`} />
    </>
  )
}
